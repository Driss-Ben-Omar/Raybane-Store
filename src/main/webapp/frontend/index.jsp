							...
							<div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
								<div class="hero__caption">
									...
									<p data-animation="fadeInLeft" data-delay=".7s"
										data-duration="2000ms"
										style="font-family: sans-serif; text-align: justify;">Discover
										iconic eyewear that never goes out of fashion at the Ray-Ban
										Store. Explore a range of sunglasses and optical frames that
										blend timeless design with exceptional quality. Experience the
										allure of Ray-Ban and elevate your style effortlessly.</p>
									<!-- Hero-btn -->
									<div class="hero__btn" data-animation="fadeInLeft"
										data-delay=".8s" data-duration="2000ms">
										<a href="index" class="btn hero-btn">Shop Now</a>
									</div>
								</div>
							</div>
							<div
								...
								<div class="hero__img" data-animation="bounceIn"
									data-delay=".4s">
									<img src="frontend/assets/img/wayfarer.png" alt=""
										style="size: 2px;" class=" heartbeat">
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row justify-content-between align-items-center">
							<div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
								<div class="hero__caption">
									<h1 data-animation="fadeInLeft" data-delay=".4s"
										data-duration="2000ms"
										style="font-family: sans-serif; text-align: justify;">Ray-Ban
										Store</h1>
									<p data-animation="fadeInLeft" data-delay=".7s"
										data-duration="2000ms"
										style="font-family: sans-serif; text-align: justify;">Discover
							...
							<div
								...
								<div class="hero__img" data-animation="bounceIn"
									data-delay=".4s">
									<img src="frontend/assets/img/aviator.png" alt=""
										class=" heartbeat">
								</div>
							</div>
						</div>
